...
Model_name = "SCNN_CrossPlusCrossDivideKL" #Change the loss function name e.g, CrossPlusKL 
path = os.path.join(BASE_PATH, filename + ".csv")
x, y, labels, vocabulary, vocabulary_inv = b2.load_encoded_BPS(path)

models_dir = os.path.join(MODEL_PATH, "Models/With_loss/")
if not os.path.exists(models_dir):
  os.makedirs(models_dir)

vocab_path = os.path.join(models_dir, "vocab_" + Model_name + ".pkl")
